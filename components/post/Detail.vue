<template>
  <div v-if="post"
       class="flex pb-8 px-1 sm:px-2 my-12 border-b md:col-span-3 border-gray-200 dark:border-gray-600 w-full">
    ...
    <div class="w-11/12 flex-grow text-base">
      ...
      <!--Tags -->
      <div v-if="post.tags" class="text-gray-500 mt-6">
      ...
      <div class="flex flex-row-reverse w-full items-center font-sans px-4 py-8 text-gray-700 dark:text-gray-200">
        <div
          class="m-1 w-12 h-12 relative flex justify-center items-center uppercase rounded-full text-xl text-white
