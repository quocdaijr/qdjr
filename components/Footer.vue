<template>
  <!-- footer -->
  <footer>
    <div class="flex flex-col justify-center items-center mt-16 text-sm text-gray-600 dark:text-gray-300">
      <div class="flex mb-3 space-x-4">
        <a target="_blank" rel="noopener noreferrer" href="mailto:quocdaijr@gmail.com">
          <span class="sr-only">Mail</span>
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16"
               class="fill-current hover:text-blue-500 dark:hover:text-blue-400 h-6 w-6">
            <path
